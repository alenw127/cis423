...
customer_transformer = Pipeline(steps=[
    ...
    ('map_gender', CustomMappingTransformer('Gender', {'Male': 0, 'Female': 1})),
    ('tukey_age', CustomTukeyTransformer(target_column = 'Age', fence='inner')),  #from chapter 4
    ('tukey_time spent', CustomTukeyTransformer(target_column = 'Time Spent', fence='inner')),  #from chapter 4
